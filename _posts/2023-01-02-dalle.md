...
hand learns how to generate new (image, cat/no cat) pairs. Generative models are usually much harder
to build. Ian Goodfellow, the father of a foundational generative technique
